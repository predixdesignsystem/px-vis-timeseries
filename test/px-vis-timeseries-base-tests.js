...
function runBaseTests() {
  px_vis_timeseries_1 = document.getElementById('px_vis_timeseries_1');

  suite('Base Automation Tests for px-vis-timeseries', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-vis-timeseries fixture is created', function() {
      assert.isTrue(document.getElementById('px_vis_timeseries_1') !== null);
    });
